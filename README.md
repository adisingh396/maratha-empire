...
- **Balkanized India** — 26 state overrides `history/states/*.txt`: `HYD` 427 Hyderabad strong (5civ/4mil), `MYS` 425, `RJP` 433/989/991, `WIS` 428 Gujarat, `SIN` 443, `KAS` 441 Kashmir, `PJB` 440/442 Punjab frontier, `BEN` 430/431 Bengal, `CIP` 436/437 etc. RAJ reduced to residual (RAJ_1936 empty `units={}`).
